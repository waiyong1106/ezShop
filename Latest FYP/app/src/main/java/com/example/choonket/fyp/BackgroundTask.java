    ...
    protected Void doInBackground(Void... voids) {
        ...
        try{
            ...
            JSONArray JA = new JSONArray(data);
                ...
                JSONObject JO = (JSONObject) JA.get(shopDetails.data2);

                    singleParsed =
                                    JO.get("locationName") + "\n" +
                                            JO.get("locationAddress") + "\n" +
            ...
            String phoneNumber = JO.get("locationContact").toString();

            globalVariable.phoneNumberFromDetails = phoneNumber;

            String tempshopLongtitude = JO.get("Longtitude").toString();
            String tempshopLaitutude = JO.get("Latitude").toString();

            globalVariable.detailsLongtitude = tempshopLongtitude;
            globalVariable.detailsLatitude = tempshopLaitutude;
