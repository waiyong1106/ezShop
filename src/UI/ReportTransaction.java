...
public class ReportTransaction extends javax.swing.JFrame {
    ...
    try{
            ...
            ArrayList<domain.Booking> bookarray = bt.retrieveBook();
            DefaultTableModel model = (DefaultTableModel)jTable1.getModel();
            model.setRowCount(0);
                       
                for(int i=0; i<bookarray.size();i++){
                domain.Booking b = bookarray.get(i);
                
                String c1 = b.getBookID();
                String c2 = b.getMemID();
                String c3 = b.getScheID();
                String c4 = b.getSeatType();
                int c5 = b.getSeatBook();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Booking ID", "Member ID", "Schedule ID", "Seat Type", "Booking Seat", "Price"
            }
        ) {
